...
export default function Contact() {
  ...
  const bookingSettings = sections.booking_settings;
  ...
  return (
    <div className="bg-white">
            ...
            >
              ...
              <div className="mt-10 flex items-center justify-center">
                <button
                  ...
                  className="rounded-md bg-blue-900 px-8 py-4 text-lg font-semibold text-white shadow-sm hover:bg-blue-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-900 transition-colors duration-200"
                >
      ...
      {/* Contact Methods */}
      {(contactMethodsHeader || contactInfo) && (
        <section className="py-16 sm:py-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            {contactMethodsHeader && (
              <div className="mx-auto max-w-2xl text-center">
                <h2 className="text-base font-semibold leading-7 text-blue-900">{contactMethodsHeader.subtitle}</h2>
                <p className="mt-2 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
                  {contactMethodsHeader.title}
                </p>
              </div>
            )}
      ...
      {/* Hidden Calendar - triggered by button */}
      <BookingCalendar
        ref={calendarRef}
        hideCalendar
        className="hidden"
        refundPolicyText={bookingSettings?.refund_policy_text}
      />
