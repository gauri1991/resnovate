...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,*.railway.app,*.up.railway.app,resnovate.in,www.resnovate.in', cast=lambda v: [s.strip() for s in v.split(',')])
